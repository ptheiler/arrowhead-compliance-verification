...
import static eu.arrowhead.common.RegistryResource.LOOKUP_PATH;
import static eu.arrowhead.common.RegistryResource.PUBLISH_PATH;
import static eu.arrowhead.common.RegistryResource.UNPUBLISH_PATH;
...
public class DeviceRegistryResource
    //implements RegistryResource<DeviceRegistryEntry, Response>
{
  ...
  @POST
  @Path(PUBLISH_PATH)
  public Response publish(@Valid final DeviceRegistryEntry entry, @Context final SocketAddress address) throws ArrowheadException {
    DeviceRegistryEntry returnValue;
    Response response;

    returnValue = registryService.publish(entry, address);
